...
Work through a draft together.

## Process

### 1. Identify the file

If a file path is clear from the conversation, use it. If not, ask before doing anything else — don't guess or assume.

### 2. Load reference skills
