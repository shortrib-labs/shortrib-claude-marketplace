...
description: Use when developing, refining, or documenting a strategy for a team, project, or initiative. Use when someone says they want to think through a strategy, write a strategy doc, or figure out their approach to an opportunity.
---

# Crafting Strategy

A Socratic guide for developing strategy in the style of Richard Rumelt's *Good Strategy Bad Strategy*, made practical by Will Larson's *Crafting Engineering Strategy*, adapted for an opportunity-first culture.
...
## The Strategy Kernel (adapted from Rumelt)
...
- "What happens if we don't pursue this? What do we lose?"
- "What's changed recently that makes this worth pursuing now?"
- "Is this one opportunity or several tangled together?" (If several, pick one to start)
...
- **Market/external:** "What's happening in the market that creates this opening? Who else sees it?"
- **Internal capabilities:** "What do we already have that positions us well? What are we missing?"
- **Constraints:** "What are the real constraints - time, money, people, technology, politics?"
- **Competitive position:** "What gives us an edge? What's our unique advantage here?"
- **Timing:** "Why is now the right moment? What happens if we wait 6 months?"
- **Scale:** "What's the team size and operating tempo? Process density that's normal at 200+ people is overhead at 35."

**Refinement questions** (use when something feels off):
- "You said X, but earlier you said Y - how do those fit together?"
- "Who would disagree with that assessment? What would they say?"
- "What data supports that? What would change your mind?"
- "Is that a fact or an assumption? How confident are you?"
...
- "What are you saying NO to by choosing this approach?" (If they can't name what they're sacrificing, the policy isn't real)
- "If two teams disagreed on a decision, how would this policy help them resolve it?"
- "Is this policy specific enough to actually guide decisions, or could anyone nod along without changing behavior?"
- "What fundamental rules should everyone follow?"

**Larson's three policy questions:**
1. "How should resources be allocated against this?"
2. "What rules must all teams follow?"
3. "How are decisions made - what can teams decide independently vs. what needs escalation?"

**Altitude check** (each policy should pass):
- Is it **applicable** in real scenarios involving tradeoffs?
- Can it be **enforced** with clear accountability?
- Does it create **leverage** - compounding or multiplicative impact?
...
Follow-ups:
- "How do these actions reinforce each other?" (Coherence test)
- "What's the sequence? What has to happen first?"
- "What are the proximate objectives - what can we actually hit in the next 30-90 days?"
- "What would tell us this is working? What would tell us to change course?"
- "Who owns each action? How do we handle exceptions?"
- "What's the critical path? What's the one thing that, if it slips, delays everything?"
...
- **Enforcement:** How do we maintain policy compliance?
- **Escalation:** How do people constructively challenge the policy?
- **Transitions:** How do we move from current state to desired state?
...
1. **What we're doing** (the plan, the approach -- lead with the decision)
2. **How we're doing it** (actions, timeline, owners, launch plan)
3. **Why we believe this is right** (opportunity, landscape, data, hypothesis)
4. **What's out of scope** (what we're not doing and why)
5. **Open questions** (what we don't know yet, what would change our mind)
...
**Writing guidelines:**
- Be specific. "We never compromise on quality" is a bumper sticker, not strategy.
- Show your work. Document rationale so others can adapt when context shifts.
- Include at least one thing you're saying NO to.
- Name the uncomfortable truths in the landscape.
- Keep it to 1-3 pages. If it's longer, it's probably a vision document, not a strategy.
- **Write in the strategist's voice, not the framework's voice.** Use the taste skill and apply rules with the "Strategy Documents" adaptation. If the document reads like it was generated by a template, rewrite it. Use plain language, direct statements, and the words the strategist actually used in conversation.
- **Match process weight to company size.** Before finalizing, scan the doc with a company-size filter. Would a company of this headcount actually run this process, or are we writing the process a bigger company would have? AI brainstorming partners often translate judgment-based criteria into formal approval flows even when explicitly told not to. The human writing the strategy is the last filter against process inflation.

## Hallmarks of Bad Strategy (Red Flags to Call Out)
...
| **Process bloat** | Formal approval flows, sign-offs, written justifications, or documentation gates that exceed what the company's size actually needs |
